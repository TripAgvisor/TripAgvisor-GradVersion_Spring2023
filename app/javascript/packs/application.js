...
//
  ...
  $(document).off('click', '.portal-experience-photo').on('click', '.portal-experience-photo', function(e){
  ...
  $(document).off('click', '.portal-experience-photo').on('click', '.portal-experience-photo', function(){
